...
output_path = os.path.join(test_config.output_path,'02_create_deformed_image')
...
# read
path_to_sim_vtu = os.path.join(test_config.output_path,'01_forward_simulation', 'merged', 'all_00199000000.vtu')
