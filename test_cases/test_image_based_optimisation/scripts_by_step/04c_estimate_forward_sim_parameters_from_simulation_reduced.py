...
output_path = os.path.join(test_config.path_04_optimization_from_sim_reduced, 'reloaded_from_03')
#output_path = os.path.join(test_config.path_04_optimization_from_sim_reduced, 'reloaded_from_01b')
#output_path = os.path.join(test_config.path_04_optimization_from_sim_reduced, 'direct_from_sim')
...
# # direct from sim
# path_to_sim_conc_reduced = os.path.join(output_path_1_red, 'concentration_simulated_direct.h5')
# conc_sim = dio.read_function_hdf5('function', sim.functionspace.get_functionspace(subspace_id=1),path_to_sim_conc_reduced)
#
# path_to_sim_disp_reduced = os.path.join(output_path_1_red, 'displacement_simulated_direct.h5')
# disp_sim = dio.read_function_hdf5('function', sim.functionspace.get_functionspace(subspace_id=0),path_to_sim_disp_reduced)


# # reloaded in 01b
path_to_sim_conc_reduced = os.path.join(output_path_1_red, 'concentration_simulated.h5')
conc_sim = dio.read_function_hdf5('function', sim.functionspace.get_functionspace(subspace_id=1),path_to_sim_conc_reduced)

path_to_sim_disp_reduced = os.path.join(output_path_1_red, 'displacement_simulated.h5')
disp_sim = dio.read_function_hdf5('function', sim.functionspace.get_functionspace(subspace_id=0),path_to_sim_disp_reduced)

# from registration, projected into reduced domain
