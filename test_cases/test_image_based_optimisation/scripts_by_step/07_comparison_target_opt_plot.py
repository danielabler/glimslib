...
output_path = test_config.path_06_comparison
...
labelfunction, mesh_full, subdomains, boundaries = dio.load_function_mesh(test_config.path_to_2d_labelfunction)

sim_orig = TumorGrowthBrain(mesh_full)


tissue_id_name_map_full = {    0: 'outside',
                          1: 'CSF',
                          3: 'WM',
                          2: 'GM',
                          4: 'Ventricles'}
...
sim_orig.setup_global_parameters(subdomains=subdomains,
                             domain_names=tissue_id_name_map_full,
                             boundaries=boundary_dict,
                             dirichlet_bcs=dirichlet_bcs,
                             von_neumann_bcs=von_neuman_bcs
                             )
...
output_path_orig = test_config.path_01_forward_simulation
...
plott.show_img_seg_f(function=conc_orig, path=os.path.join(output_path,'conc_orig.png'))
