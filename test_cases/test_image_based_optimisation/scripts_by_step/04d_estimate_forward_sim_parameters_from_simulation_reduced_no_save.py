...
output_path = test_config.path_04_optimization_from_sim_reduced_no_save
...
conc_sim = sim.functionspace.project_over_space(conc_target_0, subspace_id=1, annotate=False)
disp_sim = sim.functionspace.project_over_space(disp_target_0, subspace_id=0, annotate=False)
